    ...
    while (is_running) {
...

        {
            ...
            if (::vad_simple(pcmf32_cur, WHISPER_SAMPLE_RATE, 1250, params.vad_thold, params.freq_thold, params.print_energy) || force_speak) {
                ...
                if (!force_speak) {
					printf(" !force_speak ");
					//std::cout << pre::json::to_json(params) << std::endl;
					//printf(pcmf32_cur.c_str());
					printf("; prompt_whisper: ");
					printf(prompt_whisper.c_str());
					printf("; prob0: ");
					printf("%f", prob0);
					printf("; t_ms: ");
					printf("%f", t_ms);
